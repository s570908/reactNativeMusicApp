    ...
    render() {
        return (
            <View style={{ flex: 1, alignItems: "center" }}>
                ...
                <LinearGradient colors={['rgba(0,0,0,0)', '#e207b04f', '#e207b07f', '#e207b0']} style={{ position: 'absolute', bottom: 0, width: '100%', height: 670 }} />
                <View style={{ ...styles.searchArea1, width: '90%' }}>
                    <View style={{ flexDirection: 'row', width: '100%', marginTop: 120 }}>
                        ...
                        >
                            <Text style={{ fontSize: 20 }}>{strings.cancel}</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={{ width: '100%' }}>
                        <Text style={{ marginTop: 10 }}>{strings.search}</Text>
                    </View>
