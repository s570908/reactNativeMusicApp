...
import { View, Text, ImageBackground, TextInput, TouchableOpacity, StatusBar, AsyncStorage, Image, Dimensions } from 'react-native';
...
export default class Signup extends Component {
    ...
    handleSignUp = () => {
        ...
        if (this.state.firstname == "") {
            ...
            axios.post('http://192.168.110.249:8000/api/auth/register', body)
                .then((response) => {
    ...
    render() {
        return (
            <ImageBackground
                ...
                {/* {
                    this.state.loading && (
                        <BarIndicator color='#e207b0' count={5} style={{ position: 'absolute', alignSelf: "center", marginTop: height * 0.5, zIndex: 1000 }} />
                    )
                } */}
